! function() {
    "use strict";
    var d, l, s, e, t, o, h = window.document,
        n = h.location,
    ...
    l = "github-button", d = (/^http:/.test(n) ? "http" : "https") + "://buttons.github.io", s = "/buttons.html", e = function(e) {
        d = e
    }, t = "currentScript", o = !{}.hasOwnProperty.call(h, t) && h[t] && delete h[t] && h[t] ? h[t].src : void 0;
    var f, g, a;
    f = function(e, t, o) {
    ...
    m = function(e, t) {
        ...
        1 < (l = b[e] || (b[e] = [])).push(t) || (a = 0, n = function() {
            if (!a && (a = 1))
                for (delete b[e]; t = l.shift();) t.apply(null, arguments)
        ...
        var r, a, n, i, l, c, d, s, h, p, u, f, g, b;
        ...
        var e, t, o, n, r, a, i;
        if (t = [], h.querySelectorAll) t = h.querySelectorAll("a." + l);
        else
            for (o = 0, r = (i = h.getElementsByTagName("a")).length; o < r; o++) ~(" " + (e = i[o]).className + " ").replace(/[ \t\n\f\r]+/g, " ").indexOf(" " + l + " ") && t.push(e);
        ...
        if (null == n && (n = function(e) {
            ...
            }(o)), (e = window.HTMLElement) && e.prototype.attachShadow && !e.prototype.attachShadow.prototype) t = u("span"), (l = n.title) && (t.title = l), v(t.attachShadow({
            mode: "closed"
        }), n, function() {
            ...
            F(r, [1, 0]), r.style.border = "none", r.src = "javascript:0", g(r, "load", function() {
                ...
                e = r.contentWindow, v.call(e, e.document.body, n, function(e) {
                    ...
                    t = y(e), r.parentNode.removeChild(r), g(r, "load", function() {
                        ...
                        var t, o, n;
                        for (t in o = [], e) null != (n = e[t]) && o.push(p(t) + "=" + p(n));
                        return o.join("&")
        ...
        render: k
    }) : "object" == typeof exports && "string" != typeof exports.nodeName ? exports.render = k : (o && e(o.replace(/\/[^\/]*([?#].*)?$/, "")), n.protocol + "//" + n.host + n.pathname === d + s ? v(h.body, function(e) {
        var t, o, n, r, a, i;
